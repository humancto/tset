...
pub fn read_chunk(
    ...
    let abs_offset = (view_offset + chunk.byte_offset_in_view) as usize;
    let header = &file_bytes[abs_offset..abs_offset + CHUNK_HEADER_SIZE];
    ...
    let payload_start = abs_offset + CHUNK_HEADER_SIZE;
